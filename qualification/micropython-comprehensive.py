"""Portable official-firmware qualification workload for Renvo.
...
unicode_text = "Renvo \u2603 \U0001f680 caf\u00e9"
...
# RENVO_CHUNK
temporary = "/.renvo-qualification.tmp"
renamed = "/.renvo-qualification.done"
try:
    try:
        os.remove(temporary)
    except OSError:
    ...
    try:
        ...
        pass
    content = b"renvo-storage-" + bytes(range(32))
    ...
    require(".renvo-qualification.done" in os.listdir("/"), "filesystem directory")
...
print("RENVO_QUAL_DIGEST", digest)
print("RENVO_QUAL_OK", len(evidence))
