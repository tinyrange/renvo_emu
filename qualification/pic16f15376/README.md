...
entry/return, DAC1 code selection, and EUSART1 output. Every build must emit
`PIC16F15376:OK\nIRQ\n`.
...
transfers, the normalized DAC1 code and enable/output controls, and watchdog
reset. Timer, serial and SPI timing are deterministic approximations. MSSP1
I²C/slave operation, analog modules, serial receive timing, and unlisted
...
and runs the original register-level Timer0, Timer2, and DAC1 programs described
under [`fixture`](fixture/README.md). They are written from the public
PIC16F15376 data sheet and must produce the expected timer edges and DAC enable
transition without incorporating Microchip application-note or SDK source.
