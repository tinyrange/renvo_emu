...
entry/return, and EUSART1 output. Every build must emit
`PIC16F15376:OK\nIRQ\n`.
...
transfers, and watchdog reset. Timer, serial and SPI timing are deterministic
approximations. MSSP1 I²C/slave operation, analog modules, serial receive
timing, and unlisted peripherals remain
...
and runs the original register-level Timer0 and Timer2 programs described under
[`fixture`](fixture/README.md). They are written from the public PIC16F15376 data
sheet and must produce the first RE0 edge without incorporating Microchip
