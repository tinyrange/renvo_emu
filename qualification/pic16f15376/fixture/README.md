# Original PIC16F15376 timer, DAC, and comparator fixtures

`remu_timer0.c`, `remu_timer2.c`, `remu_dac.c`, and `remu_comparator.c` are
original Renvo Emulator register-level qualification programs written from the
public PIC16F15376 data sheet. They do not reproduce source from Microchip
application notes or SDK examples.
