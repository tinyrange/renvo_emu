...
modulo overflow, eUSCI_A0/A1 transmit and watchdog configuration are exercised.
The same source is
...
features, eUSCI_A1 IrDA/pin routing/SPI mode, analog peripherals and unlisted serial modes remain outside this
acceptance slice.
