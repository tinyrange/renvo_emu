...
eUSCI_A0 transmit, eUSCI_B0 SPI and watchdog configuration are exercised. The same source is
...
eUSCI_A0 UART transmit/receive loopback, eUSCI_B0 SPI transfers, WDT_A reset and persistent FRAM.
Clock-tree, timer prescaling and UART bit timing are deterministic
approximations. eUSCI_B0 I2C/pin routing and analog peripherals are outside this
acceptance slice.
