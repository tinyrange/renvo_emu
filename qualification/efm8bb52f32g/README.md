...
GPIO/crossbar, Timer0/2, UART0, PCA0 three-channel PWM/capture/compare,
...
port modes and crossbar, Timer0/2, UART0, PCA0 and IE/IP/EIE1 routing. PCA0
...
hierarchical VCD signals. The machine boots
...
Timing, analog peripherals, SMBus and SPI remain explicitly
functional/deferred as stated by the target manifest. PCA timing is functional
on the abstract simulation timeline, not a silicon-clock model.
