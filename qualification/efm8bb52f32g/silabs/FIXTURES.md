...
UART0, while `remu_adc_irq.c` covers the ADC0 end-of-conversion and window
interrupt declarations. The small declaration and startup adapters expose
only the documented register surface needed by these fixtures.
