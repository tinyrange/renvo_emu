...
`remu_uart_irq.c` and `remu_timer345_irq.c` separately prove SDCC's declaration
and interrupt ABI for UART0 and the extended Timer3/4/5 vectors. The small
declaration and startup adapters expose only the documented register surface
