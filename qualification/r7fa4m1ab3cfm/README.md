...
explicit ICU routing, GPT0/GPT4 interrupt entries and SCI9 UART (`RA4M1\n`).

Implemented functionally are SYSTEM clock/oscillator and module-stop state,
IOPORT, ICU, GPT0/GPT4 counter-overflow slices, SCI9 and watchdog. GPT4 is the
documented 16-bit GPT4 instance at `0x40078400`, with ELC overflow event
`0x07d`; PWM, capture, and exact clock timing are not modeled. USB, CAN,
