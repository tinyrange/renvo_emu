...
explicit ICU routing, GPT0/GPT2 interrupt entry and SCI9 UART (`RA4M1\n`).

Implemented functionally are SYSTEM clock/oscillator and module-stop state,
IOPORT, ICU, GPT0/GPT2, SCI9 and watchdog. GPT2 is mapped at `0x40078200` and
uses ELC event `0x06d`. USB, CAN, analog/LCD blocks, exact clock
