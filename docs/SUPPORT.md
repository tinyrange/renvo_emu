...
analog amplifier settling, reference-voltage magnitude, and pin-mux
electrical behavior are outside this functional boundary. Register choices
follow the [RA4M1 hardware
