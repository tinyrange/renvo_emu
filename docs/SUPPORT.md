...
| ESP32-S3 | Xtensa LX7 windowed compiler subset | DRAM, IRAM, 16 MiB IROM and DROM windows | Windowed ABI/exception/atomic/FPU qualification; GPIO matrix waveform, native UART transcripts, I2C0/I2C1 transactions, and SPI2/SPI3 FIFO waveforms |
