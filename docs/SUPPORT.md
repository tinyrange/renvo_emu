...
| ESP32-S3 | Xtensa LX7 windowed compiler subset | DRAM, IRAM, 16 MiB IROM and DROM windows | Windowed ABI/exception/atomic/FPU qualification; GPIO matrix low bank waveform, native-address UART0 FIFO transcript, and SHA-224/SHA-256 accelerator slice |
...
The ESP32-S3 SHA accelerator is mapped at `0x6003_b000` using the native
`hwcrypto_reg.h` SHA offsets. The functional slice supports SHA-224 and
...
- Espressif ESP32-S3 and ESP32-C6 datasheets and technical reference manuals,
  ...
  [ESP32-S3 hardware-crypto register header](https://raw.githubusercontent.com/espressif/esp-idf/master/components/soc/esp32s3/include/soc/hwcrypto_reg.h)
