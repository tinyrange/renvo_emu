...
| ESP32-S3 | Xtensa LX7 windowed compiler subset | DRAM, IRAM, 16 MiB IROM and DROM windows | Windowed ABI/exception/atomic/FPU qualification; GPIO matrix low bank waveform, native-address UART0 FIFO transcript, and CPU0/CPU1 interrupt-matrix routing/status |
...
The ESP32-S3 interrupt-matrix slice maps the 99 native CPU0 route registers at
