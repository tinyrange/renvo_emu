...
| ESP32-C6 | RV32IMAC/Zicsr machine/user subset | ROM, HP/LP SRAM, 16 MiB IROM window | GPIO matrix pin 2 waveform, native UART0/1 and LP-UART transmit slices, user traps, and PMP CSR visibility |
...
- Espressif's official [ESP32-C6 register base](https://github.com/espressif/esp-idf/blob/master/components/soc/esp32c6/register/soc/reg_base.h), [UART register definitions](https://github.com/espressif/esp-idf/blob/master/components/soc/esp32c6/register/soc/uart_reg.h), and [LP UART register definitions](https://github.com/espressif/esp-idf/blob/master/components/soc/esp32c6/register/soc/lp_uart_reg.h)
