...
| PIC16F15376-I/PT | enhanced mid-range PIC16 | Intel HEX reconstructed into 14-bit words | XC8 startup, banked/linear RAM, RA input, Timer0/Timer2 IRQ, PPS TMR0/TX1 output routing, DAC1 code, C1 comparator, NCO1 output/IRQ, CLKR output, EUSART1, MSSP1 SPI/I²C host |
| EFM8BB52F32G-C-QFN32 | EFM8-flavoured MCS-51 | Intel HEX CODE image | separate CODE/IDATA/XDATA/SFR, keyed flash program/erase, crossbar GPIO, clock/power controls, Timer0-5, UART0/1, serial, PCA, ADC/DAC/comparators, CLU0-3 |
