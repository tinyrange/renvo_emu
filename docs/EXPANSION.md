...
| EFM8BB52F32G-C-QFN32 | EFM8-flavoured MCS-51 | Intel HEX CODE image | separate CODE/IDATA/XDATA/SFR, crossbar GPIO, Timer0/2, UART0, keyed flash program/page erase |
