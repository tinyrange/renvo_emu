...
|---|---|---|---|
| ATSAMD21E18A-AU | Cortex-M0+ / Armv6-M | little-endian Arm ELF | vector reset, PORT/EIC input, TC3 IRQ, SERCOM0 USART/SPI/I²C host transfers, EVSYS software event/user mux, USB device control/endpoints, DMAC descriptor transfer, I2S control/data (IRQ 27), ADC software-triggered conversion, AC comparator pair, PA07 |
