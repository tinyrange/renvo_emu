...
| PIC16F15376-I/PT | enhanced mid-range PIC16 | Intel HEX reconstructed into 14-bit words | XC8 startup, banked/linear RAM, RA input, Timer0/Timer2 IRQ, PPS TMR0/TX1 output routing, DAC1 code, C1 comparator, NCO1 output/IRQ, EUSART1, MSSP1 SPI/I²C host |
