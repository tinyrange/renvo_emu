...
| PIC16F15376-I/PT | enhanced mid-range PIC16 | Intel HEX reconstructed into 14-bit words | XC8 startup, banked/linear RAM, RA input, Timer0 IRQ, C1 comparator, EUSART1 |
