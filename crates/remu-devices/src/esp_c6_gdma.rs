...
impl EspGdmaState {
    fn new() -> Self {
        ...
        registers[IN_LINK as usize / 4] = 1 << 20;
...
#[derive(Clone)]
pub struct EspC6GdmaHandle {
    state: Arc<Mutex<EspGdmaState>>,
}

impl EspC6GdmaHandle {
...
impl EspC6Gdma {
    ...
    pub fn new(
        ...
        signal_prefix: &str,
        hub: SignalHub,
    ) -> Result<(Self, EspC6GdmaHandle), SignalError> {
