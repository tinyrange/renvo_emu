...
#[derive(Clone)]
pub struct EspC6TwaiHandle {
    state: Arc<Mutex<EspTwaiState>>,
}

impl EspC6TwaiHandle {
...
impl EspC6Twai {
    ...
    pub fn new(
        ...
        signal_prefix: &str,
        hub: SignalHub,
    ) -> Result<(Self, EspC6TwaiHandle), SignalError> {
