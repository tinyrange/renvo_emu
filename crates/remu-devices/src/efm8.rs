...
mod tests {
    use super::{
        AccessWidth, EIE1_EPCA0, Efm8PcaRegister, Efm8Peripherals, IE, IE_EA, IE_ET0, P0, P0MDOUT,
        PCA0CN_CR, SBUF0, SimTime, TCON, TCON_TR0, TMOD, XBR0, XBR0_URT0E, XBR2, XBR2_XBARE,
    };
    use remu_bus::Device;
