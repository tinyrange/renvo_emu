...
use renvo_cpu_avr::{AvrCpu, AvrRegister};
use renvo_devices::{AtmegaIo, AtmegaIoHandle, GpioHandle, SignalHub};
use renvo_image::{FirmwareArchitecture, FirmwareImage};
...
mod tests {
    use super::*;
    use renvo_image::FirmwareSegment;
