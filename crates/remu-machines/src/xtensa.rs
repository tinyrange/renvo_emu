...
use remu_devices::{
    DeterministicRng, Esp32S3SarAdc, Esp32S3SarAdcHandle, EspGpio, EspMmuTable, EspMmuTableHandle,
...
impl XtensaMachine {
    ...
    /// Returns the host-side ESP32-S3 SAR ADC input and observation handle.
