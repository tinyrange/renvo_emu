...
const MANIFESTS: &[TargetManifest] = &[
    ...
    TargetManifest {
        ...
        baseline: &[
            ...
            "Timer0/2",
            "UART0",
            "configurable logic units (CLU0-3)",
            "interrupt priority",
            "VCD",
        ],
        sources: &[
        ...
        limitations: &[
            "CLU timer/PWM/serial routing and direct-pin crossbar output, analog, PCA, SMBus, SPI, and historical 8051 machine timing are deferred",
        ],
    },
];
