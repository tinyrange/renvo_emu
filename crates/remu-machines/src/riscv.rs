...
use remu_devices::{
    ...
    RpTimerLayout, SignalHub, TimerHandle, UartHandle, WchGpio, WchPfic, WchTimer, WchUsart,
};
use remu_image::{
...
mod rp_bootrom;
mod wch_exti;
use wch_exti::{WchHandles, map_wch_exti, poll_wch_exti, poll_wch_timer};
...
impl RiscVMachine {
    ...
    pub fn new(target: TargetId) -> Result<Self, MachineError> {
        ...
        match target {
            TargetId::Ch32v003 | TargetId::Ch32v006 => {
                ...
                let exti = map_wch_exti(&mut bus, target)?;
    ...
    pub fn run_with_stimuli(
        ...
        let (mut wch_timer_was_pending, mut wch_exti_was_pending) = (false, false);
