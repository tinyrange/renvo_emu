...
use remu_devices::{
    ...
    FunctionalUart, GpioHandle, RA4M1_EVENT_GPT0_OVERFLOW, RA4M1_EVENT_KINT, RA4M1_EVENT_SCI9_TXI,
    RaGpt, RaGptHandle, RaIcu, RaIcuHandle, RaIoPort, RaKint, RaKintHandle, RaPfs, RaSci,
...
impl ArmMcuMachine {
    ...
    pub fn new(target: TargetId) -> Result<Self, ArmMachineError> {
        ...
        let (gpio, uart, timer, ra_kint, eic, ra_icu, watchdog) = match target {
            TargetId::Atsamd21e18 => {
    ...
    fn map_ra4m1(
        ...
        bus.map_device("r7fa4m1ab3cfm.kint", 0x4008_0000, 0x100, Box::new(kint))?;
