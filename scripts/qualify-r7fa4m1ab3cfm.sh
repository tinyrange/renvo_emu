...
grep -q '^\$scope module adc0 \$end$' "$artifact_root/run-a/gpio.vcd"
grep -q '^\$scope module dac0 \$end$' "$artifact_root/run-a/gpio.vcd"
grep -q '^\$scope module elc \$end$' "$artifact_root/run-a/gpio.vcd"
