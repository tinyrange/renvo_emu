...
grep -q '^\$scope module gpt5 \$end$' "$artifact_root/run-a/gpio.vcd"
grep -q '^\$scope module gpt6 \$end$' "$artifact_root/run-a/gpio.vcd"
grep -q '^\$scope module gpt7 \$end$' "$artifact_root/run-a/gpio.vcd"
