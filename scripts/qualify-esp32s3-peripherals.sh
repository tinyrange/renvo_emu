...
for region in \
    ...
    esp32s3.i2c0 esp32s3.i2c1 esp32s3.rtc-i2c esp32s3.rtc-io esp32s3.sdm esp32s3.io-mux esp32s3.uhci0 esp32s3.syscon esp32s3.usb-wrap esp32s3.sensitive esp32s3.world-controller esp32s3.extmem esp32s3.xts-aes esp32s3.spi2 esp32s3.spi3 \
