...
grep -q 'i2c0' "$artifact_root/run-a/signals.vcd"
grep -q '\$var wire 8 .* byte \$end' "$artifact_root/run-a/signals.vcd"
grep -q '\$var wire 1 .* strobe \$end' "$artifact_root/run-a/signals.vcd"
