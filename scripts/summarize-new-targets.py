...
CASES = [
    (
        ...
        list(b"STM32H743\n"),
        {
            "RCC": (0x58024400, 0x58024800),
            "FLASH": (0x52002000, 0x52002400),
            "GPIOA": (0x58020000, 0x58020400),
            "USART3": (0x40004800, 0x40004C00),
            "TIM2": (0x40000000, 0x40000400),
            "DMA1": (0x40020000, 0x40020400),
        },
    ),
    (
        "stm32f411re",
    ...
    (
        ...
        list(b"STM32F103\n"),
        {
            "RCC": (0x40021000, 0x40021400),
            "GPIOA": (0x40010800, 0x40010C00),
            "USART1": (0x40013800, 0x40013C00),
            "TIM2": (0x40000000, 0x40000400),
        },
    ),
    (
    ...
    (
        ...
        list(b"SAMD51J19A\n"),
        {
            "MCLK": (0x40000800, 0x40000900),
            "PORTA": (0x41008000, 0x41008080),
            "SERCOM0": (0x40003000, 0x40003040),
            "TC0": (0x40003800, 0x40003840),
        },
    ),
    (
        "esp32p4",
