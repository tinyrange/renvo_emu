...
TARGETS = {
    ...
    "pic16f15376": {
        ...
        "vendor_builds": ["register-timer0-build.json", "register-timer2-build.json", "register-dac-build.json", "register-comparator-build.json", "register-pps-build.json", "register-nco-build.json"],
        "vendor_runs": ["register-timer0-run/result.json", "register-timer2-run/result.json", "register-dac-run/result.json", "register-comparator-run/result.json", "register-pps-run/result.json", "register-nco-run/result.json"],
        "edges": {
            "remu.board.pic16f15376.porta.pin0": ["0", "1"],
            "remu.board.pic16f15376.timer0.irq": ["0", "1"],
            "remu.board.pic16f15376.timer2.irq": ["0", "1"],
            "remu.board.pic16f15376.dac1.active": ["0", "1"],
            "remu.board.pic16f15376.comparator1.output": ["0", "1"],
    ...
    "efm8bb52f32g": {
        ...
        "vendor_builds": [
            "register-main-build.json",
            "register-isr-build.json",
            "register-adapter-build.json",
            "register-link.json",
        ...
        "edges": {
            ...
            "remu.board.efm8bb52f32g.smb0.tx_strobe": ["0", "1"],
            "remu.board.efm8bb52f32g.smb0.busy": ["0", "1"],
