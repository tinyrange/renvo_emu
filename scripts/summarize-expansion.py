...
TARGETS = {
    ...
    "pic16f15376": {
        ...
        "vendor_builds": ["register-timer0-build.json", "register-timer2-build.json", "register-dac-build.json"],
        "vendor_runs": ["register-timer0-run/result.json", "register-timer2-run/result.json", "register-dac-run/result.json"],
        "edges": {
