...
TARGETS = {
    ...
    "pic16f15376": {
        ...
        "vendor_builds": ["register-timer0-build.json", "register-comparator-build.json"],
        "vendor_runs": ["register-timer0-run/result.json", "register-comparator-run/result.json"],
        "edges": {
